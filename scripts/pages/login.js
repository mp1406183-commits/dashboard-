...
function renderLogin(){
  ...
  if(loginMode === 'login'){
    root.innerHTML = `<div class="login-shell"><div class="login-wrap">
      <div class="brand-lg"><span class="dot" style="width:8px;height:8px;border-radius:2px;background:var(--glow);transform:rotate(45deg);display:inline-block;"></span>MONEY MANAGER</div>
      ${loginToggleBar()}
      <h2>Welcome back</h2>
