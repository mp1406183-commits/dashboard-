  ...
  root.innerHTML = `
    <div class="section-box">
      ...
      <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap; margin: -6px 0 16px;">
        ...
        <span class="panel-sub" style="margin:0;">Works with this app's own export, or any spreadsheet with a date and amount column (bank statements included).</span>
      </div>
  ...
  document.getElementById('importExcelInput').onchange = (e) => {
    ...
    reader.onload = (evt) => {
      try{
        ...
        const { added, skipped, error } = importFromWorkbook(wb);
        ...
        alert("Couldn't read that file. Make sure it's a valid .xlsx or .xls spreadsheet.");
      }
    };
