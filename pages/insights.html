...
<title>Insights · FD - Finance Dashboard</title>
...
<main class="content" id="mainContent">
  <div class="content-header" id="contentHeader">
    ...
    <button class="btn-primary" id="headerActionBtn" style="display:none;">+ Add entry</button>
  </div>
  <div id="root">
...
<script src="../scripts/pages/insights.js"></script>
</body>
</html>
