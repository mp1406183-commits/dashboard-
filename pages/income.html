...
<title>Income · FD - Finance Dashboard</title>
...
<main class="content" id="mainContent">
  <div class="content-header" id="contentHeader">
    <div>
      <h1 id="pageTitle">Income</h1>
      <div class="sub" id="dateSub"></div>
    </div>
    <button class="btn-primary" id="headerActionBtn">+ Add income</button>
  </div>
  <div id="root">
...
<script src="../scripts/pages/income.js"></script>
</body>
</html>
